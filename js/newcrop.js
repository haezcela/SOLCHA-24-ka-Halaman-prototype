  ...
  querySnapshot.forEach((doc) => {
    ...
    [cell1, cell2].forEach((cell) => {
      ...
      cell.addEventListener("click", () => {
        ...
        document.getElementById("modalInitialBudget").textContent =
...
document
  .getElementById("toggleAddTodoFormBtn")
  .addEventListener("click", function () {
    const imageAndBudgetSection = document.getElementById(
      "imageAndBudgetSection"
    );
...
//For hiding add to do buttons
document.addEventListener("DOMContentLoaded", function () {
  // Get reference to the "Add To Do" button and the form section
  var addToDoBtn = document.getElementById("toggleAddTodoFormBtn");
  var addToDoFormSection = document.getElementById("addTodoFormSection");

  // Add event listener to the "Add To Do" button
  addToDoBtn.addEventListener("click", function () {
    // Hide the "Add To Do" button
    addToDoBtn.style.display = "none";
    // Show the add todo form section
    addToDoFormSection.style.display = "block";
  });

  // Get reference to the "Save Todo" button
  var saveTodoBtn = document.getElementById("saveTodoBtn");

  // Add event listener to the "Save Todo" button
  saveTodoBtn.addEventListener("click", function () {
    // Show the "Add To Do" button again
    addToDoBtn.style.display = "block";
    // Hide the add todo form section
    addToDoFormSection.style.display = "none";
  });
});
